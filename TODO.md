...
* [o] test and refactor confidence propagation code
* [ ] ratio confidence sub hypothesis to full hypothesis
* [ ] closest confidence to the max confidence given some constraints
